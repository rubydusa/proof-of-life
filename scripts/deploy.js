...
async function main() {
    ...
    const golMetadata = await GOLMetadata.deploy("https://proof-of-life.netlify.app");
    ...
    fs.writeFileSync(path.join(__dirname, "deployment_data.json"), JSON.stringify(deploymentData, null, 4));
}
